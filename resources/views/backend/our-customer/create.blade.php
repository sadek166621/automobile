    	...
    	<div class="col-sm-10">
    		<div class="card">
		        <div class="card-body">
		            <div class="row">
		                <div class="col-md-12">
		                    <form method="post" action="{{ route('our-customer.store') }}" enctype="multipart/form-data">
		                    	@csrf
		                        <div class="mb-4">
		                           <label for="title_en" class="col-form-label col-md-2" style="font-weight: bold;"> Product Code:</label>
		                            <input class="form-control" id="title_en" type="text" name="product_code" placeholder="Write Our-customer Product Code"  value="{{old('product_code')}}">
		                            @error('product_code')
		                        ...
		                        <div class="mb-4">
		                          <label for="our-customer_url" class="col-form-label col-md-2" style="font-weight: bold;"> Delivered to:</label>
		                            <input class="form-control" required id="delivered" type="text" name="delivered" placeholder="Write our-customer Delivered To" value="{{old('delivered')}}">
		                        </div>
		                        <div class="mb-4">
		                          <label for="our-customer_url" class="col-form-label col-md-2" style="font-weight: bold;"> Delivery Date:</label>
		                            <input class="form-control" required id="delivery_date" type="date" name="delivery_date" placeholder="Write our-customer delivery_date" value="{{old('delivery_date')}}">
		                        </div>
		                        <div class="mb-4">
