...
{{--                            @endif--}}
		        		...
		        		<div class="row">
							...
							<div class="col-md-6 mb-4">
								<label for="stock_qty" class="col-form-label" style="font-weight: bold;">Stock Quantity:</label><span class="text-danger">*</span>
								<input class="form-control" type="number" name="stock_qty" value="{{$product->stock_qty}}" placeholder="Write product stock qty" required>
								@error('stock_qty')
									<p class="text-danger">{{$message}}</p>
								@enderror
							</div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="number" name="points" value="{{ $product->points }}" class="form-control" placeholder=" Add Points">
                                </div>
                                <!-- Description End -->
                            </div>
                        </div>
		        	...
		        	<div class="card-body">
		        		<div class="row">
	                        ...
	                        <div class="col-md-6 mb-4 d-none">
	                            ...
	                            <textarea name="short_description_bn" rows="2" cols="2" class="form-control summernote" placeholder="Write Short Description Bangla">{{$product->short_description_bn}}</textarea>
	                        </div>
	                        <!-- Description End -->
		        		</div>
		        	</div>
		        ...
		        <div class="card">
		        	...
		        	<div class="card-body">
		        		<div class="row">
	                        ...
	                        <div class="col-md-12 mb-4">
	                          	<label for="long_descp_en" class="col-form-label" style="font-weight: bold;">Description: </label><span class="text-danger">*</span>
	                            <textarea name="description_en" rows="2" cols="2" class="form-control summernote" placeholder="Write Long Description English" required>{{ $product->description_en }}</textarea>
	                        </div>
	                        <div class="col-md-6 mb-4 d-none">
	                          	<label for="long_descp_bn" class="col-form-label" style="font-weight: bold;">Description (Bn): </label>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function get_flash_deal_discount(){
            var product_ids = $('#products').val();
            if(product_ids.length > 0){
                $.post('{{ route('group_product.product_discount_edit') }}', {_token:'{{ csrf_token() }}', product_ids:product_ids, campaing_id:{{ $product->id }}}, function(data){
                    $('#discount_table').html(data);
                });
            }
            else{
