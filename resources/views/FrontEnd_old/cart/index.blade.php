...
{{--                    @auth--}}
                        <a href="{{route('checkout')}}" onclick="" class="btn btn-primary btn-lg d-block fw-semibold py-2 px-4">Proceed To
                            Checkout</a>
{{--                    @endauth--}}
{{--                    @guest--}}
{{--                        --}}{{-- <button type="submit" class="btn btn-primary btn-lg d-block fw-semibold py-2 px-4">Place Order</button> --}}
{{--                        @if(session()->get('language') == 'bangla')--}}
{{--                        <a href="{{ route('login') }}" class="btn btn-primary btn-lg d-block fw-semibold py-2 px-4">অর্ডার করুন</a></span>--}}
{{--                        @else--}}
