...
{{--        <div class="" >--}}
{{--            <a style="color: green; font-weight: 900; font-size: 16px; margin-bottom: 10px" href="{{ route('home') }}"><i class="fa-solid fa-backward"></i> Back to--}}
{{--                Home</a><br>--}}
{{--            <a style="color: green; font-weight: 900; font-size: 16px;" href="{{ route('dashboard') }}"><i class="fa-solid fa-backward"></i> Back to--}}
{{--                Dashboard</a>--}}
{{--        </div>--}}
{{--        --}}
{{--        --}}
...
{{--    </div>--}}
    <div class="row">
        <div class="col-md-6 col-6">
            <a style="color: green; font-weight: 900; font-size: 16px; margin-bottom: 10px" href="{{ route('home') }}"> Back to
                            Home</a>
                    </div>
                    <div class="col-md-6 col-6 d-none" style="text-align: right">
                                    <a style="color: green; font-weight: 900; font-size: 16px; text-align: right" href="{{ route('dashboard') }}">Back to
                                        Dashboard</a>
                    </div>
                </div>
                                    ...
                                    <div class="tm_border tm_accent_border_20">
                                        <div class="tm_table_responsive">
                                            <table>
                                                <thead>
                                                <tr>
{{--                                                    @php $count_replaceable= countReplaceable($order); @endphp--}}
...
{{--                                                    @if($order->delivery_status == 'delivered' && $count_replaceable != 0)--}}
{{--                                                        <th class="tm_width_2 tm_semi_bold tm_accent_color tm_accent_bg_10 tm_text_right d-none">Action</th>--}}
{{--                                                    @endif--}}
                                                </tr>
                                                </thead>
                                                <tbody>
                                                @php
            //                                    $product = \App\Models\OrderDetail::where('product_id', 79)->first();
            //;
                                                ...
                                                @foreach($order->order_details as $key=> $order_detail)
                                                    <tr>
                                                        ...
                                                        @if($order->delivery_status == 'delivered' )
                                                            <td class="d-none tm_width_2 tm_accent_border_20 tm_text_right">
{{--                                                                @if($count_replaceable > 0 && $order_detail->product->is_replaceable == 1)--}}
{{--                                                                    <button--}}
{{--                                                                        onclick="checkReturn({{$order->id}}, {{$order_detail->product_id}}, {{$order_detail->id}})" class="btn btn-outline-primary" style="font-size: 12px">Return</button>--}}
{{--                                                                @endif--}}
                                                            </td>
                                                        @endif
                                                    </tr>
                                    ...
                                    <div class="tm_invoice_footer tm_mb15 tm_m0_md">
                                        ...
                                        <div class="tm_right_footer">
                                            ...
                                            @if($order->delivery_status == 'pending')
                                                <div class="d-none" style="display: flex; float: right; justify-content: space-between; padding: 8px 0px;">
                                                    <div class="">
                                                        <form action="{{ route('order.cancel.submit') }}" method="post" id="cancelOrderForm">
                                                            @csrf
                                                            <input type="hidden" name="order_id" value="{{$order->id}}">
                                                            <input type="hidden" name="request_type" value="1">
                                                            <input type="hidden" name="status" value="cancel_requested">
                                                        </form>
                                                        <a style="color: red; font-weight: 600; font-size: 16px;" href="#" onclick="event.preventDefault(); $('#cancelOrderForm').submit()"><i class="fa-solid fa-backward"></i> Cancel Order</a> <br>
                                                    </div>
                            ...
                            <div class="tm_bottom_invoice tm_accent_border_20">
                                ...
                                <div class="tm_bottom_invoice_right tm_mobile_hide">
                                    <div class="tm_logo">
                                        @php
                                            $logo = get_setting('site_logo')->value;
                                        @endphp
                                        @if($logo != null)
                                            <img src="{{ asset($logo ?? 'null') }}" style="max-width: 200px !important;" alt="{{ env('APP_NAME') }}">
                                        @else
        ...
        <div class="tm_invoice_btns tm_hide_print" style="margin-bottom: 10px">
            ...
            <a href="{{route('order.download', $order->invoice_no)}}" id="" class="tm_invoice_btn tm_color3" style="margin-bottom: 5px;">
...
<script>
    function checkReturn(id, product_id, order_details_id) {
        $.ajax({
            type: 'get',
            url: '{{route('order.return.check')}}',
            dataType: 'json',
            data:{
                order_id: id,
            ...
            success: function (data) {
                ...
                if (data.result) {
                    ...
                    {{--let url = '{{ route( "order.return", [ ':invoice', ':slug' ] ) }}';--}}
