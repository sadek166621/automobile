...
<head>
    ...
    <meta name="author" content="SkyDreamIT">
    {{--    <!-- Favicon Link-->--}}
    <link rel="shortcut icon"
          href="./assets/img/sky-dream-it-skydreamit-tanmoy-biswas-ceo-webdesigner-wordpress-expert.png" type="image/x-icon">
    ...
    <style>
        @font-face {
            ...
            url('public/FrontEnd/assect/font/DejaVuSans.ttf') format('truetype'),
            font-weight: normal;
            font-style: normal;
        }
...
<div class="tm_invoice tm_style2 tm_type1 tm_accent_border tm_radius_0 tm_small_border" id="tm_download_section">
    <div class="tm_invoice_in">
        <table style="width: 600px">
            <tr>
                <td width="100px">
                    <div class="tm_logo" style="left: -16px; top:5px">
{{--                        <img src="data:image/png;base64,{{base64_encode(file_get_contents(base_path('public/backend/assets/imgs/sky-dream-it-skydreamit-tanmoy-biswas-ceo-webdesigner-wordpress-expert.png')))}} " width="120px">--}}
                        @php
                            $logo = get_setting('site_favicon')->value;
                        @endphp
                        @if($logo != null)
                            <img src="data:image/png;base64,{{base64_encode(file_get_contents(base_path('public/'.$logo)))}} " style="max-width: 200px !important;" alt="{{ env('APP_NAME') }}">
...
{{--                            <img src="{{ asset('upload/no_image.jpg') }}" alt="{{ env('APP_NAME') }}" style="max-width: 200px !important;">--}}
                ...
                <td width="120px">
                    ...
                    <div class="tm_shape_bg tm_accent_bg_10 tm_border tm_accent_border_20" style=""></div>
                </td>
            ...
            <tr>
                <td>
                    <p class="tm_mb0">
                        ...
                        <b class="tm_primary_color">Invoice Date: </b>{{ date('d-m-Y', strtotime($order->created_at)) }}
                    </p>
                </td>
                <td>
        ...
        <h2 class="tm_f16 tm_section_heading tm_heading_border tm_accent_border_20 tm_mb0" style="transform: skewX(-35deg); margin-left: 12px"><span
                class="tm_accent_bg_10 tm_radius_0 tm_curve_35 tm_border tm_accent_border_20 tm_border_bottom_0 tm_accent_color"><span style="transform: skewX(35deg)">Invoice
            To</span></span></h2>

        <div class="tm_table tm_style1 tm_mb30">
            <div class="tm_border  tm_accent_border_20 tm_border_top">
                <div class="tm_table_responsive">
                    <table>
                        <tbody>
                        <tr>
                            <td class="tm_width_7 tm_border_top_0">
                                <b class="tm_primary_color tm_medium">Name: </b>{{$order->user->name}}
                            </td>
                            <td class="tm_width_7 tm_border_top_0 tm_border_left tm_accent_border_20">
                                <b class="tm_primary_color tm_medium">Phone: </b> {{ $order->phone ?? '' }}
                            </td>
                        </tr>
                        <tr>
                            <td class="tm_width_7 tm_accent_border_20">
                                <b class="tm_primary_color tm_medium">Email: </b>{{$order->email ?? ''}}
                            </td>
                            <td class="tm_width_7 tm_border_left tm_accent_border_20">
        ...
        <div class="tm_table tm_style1">
            <div class="tm_border tm_accent_border_20">
                <div class="">
                    <table>
                        <thead>
                        <tr>
                            <th class="tm_width_1 tm_semi_bold tm_accent_color tm_accent_bg_10">SL</th>
                            <th class="tm_width_8 tm_semi_bold tm_accent_color tm_accent_bg_10">Item</th>
                        ...
                        @foreach($order->order_details as $order_detail)
                            <tr>
                                <td class="tm_width_4 tm_accent_border_20">{{$i++}}.</td>
                                ...
                                <td class="tm_width_1 tm_accent_border_20">{{$order_detail->qty ?? ''}}</td>
                                </td>
            ...
            <div class="tm_invoice_footer tm_mb15 tm_m0_md">
                <div class="">
                    <table class="tm_mb15 tm_m0_md" style="border:none !important" >
                        <tbody>
                        <tr>
                            <td colspan="3" rowspan="3" class="tm_border_none ">
...
{{--                            <td colspan="3" class="tm_border_none "><p class="tm_m0">Payment Status: Unpaid</p></td>--}}
                        ...
                        <tr class="tm_border_none" style="border:none !important;">
                            ...
                            <td class="tm_width_3 tm_bold tm_f16 tm_accent_color tm_accent_bg_10">Grand
                                Total </td>
                            <td colspan="2"
...
<footer style="position: fixed; bottom: 30px;">
    <table width="600px">
        ...
        <tr style="padding-top: 100px">
            <td colspan="4" style="margin-right: 80px !important;">
                <p class="tm_m0 tm_f18 tm_accent_color tm_mb5" style="margin-right: 150px !important;">Thank you for your business.</p>
            ...
            <td align="right" style="padding-left: 100px">
                ...
                @endphp
                @if($logo != null)
                        <img src="data:image/png;base64,{{base64_encode(file_get_contents(base_path('public/'.get_setting('site_favicon')->value)))}} "  alt="{{ env('APP_NAME') }}" height="150px" width="150px">

                @else
                    <img src="{{ asset('upload/no_image.jpg') }}" alt="{{ env('APP_NAME') }}">
                @endif
{{--                <img src="data:image/png;base64,{{base64_encode(file_get_contents(base_path('public/backend/assets/imgs/sky-dream-it-skydreamit-tanmoy-biswas-ceo-webdesigner-wordpress-expert.png')))}} " width="120">--}}
            </td>
        </tr>
    </table>
</footer>
