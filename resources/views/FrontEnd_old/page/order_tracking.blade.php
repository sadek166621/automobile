                        ...
                        <div class="col-xl-10 col-lg-10 col-md-12 m-auto">
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block">
                                    <img class="border-radius-15" style="height: 433px;" src="{{asset('FrontEnd/assect/img/logo/Captureimgae.PNG')}}" alt="" />
                                </div>
                                    ...
                                    <div class="login_wrap widget-taber-content background-white">
                                        <div class="padding_eight_all bg-white">
                                            ...
                                            <form method="get" action="{{ route('order.track') }}" class="row g-3 needs-validation" novalidate>
                                                ...
                                                <div class="form-group">
                                                    <button class="btn btn-primary py-3 px-5 text-white" type="submit">Track</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
