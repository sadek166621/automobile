    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-6 m-auto p-4">
                <h2>User Login</h2>
                <span>Have not an account? <a href="{{ route('register') }}"><small>Sign Up</small></a></span>
                <form class="row g-3 mt-3" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="password" name="password" placeholder="Your password *" autocomplete="current-password" value="{{ old('password')}}" class="form-control" placeholder="********" required>
                    </div>
                    {{-- <div class="col-md-12">
                        <div class="row">
                            {{-- <div class="col-lg-6">
