    ...
    <div class="auto-container">
        <div class="slider-icons-outer parallax-scene-1">
            ...
            <div class="pattern-layer-four"
                style="background-image: url({{ asset('FrontEnd') }}/assets/images/main-slider/pattern-4.png)"></div>
            <div class="pattern-layer-six"
                style="background-image: url({{ asset('FrontEnd') }}/assets/images/main-slider/pattern-6.png)"></div>
        </div>
        ...
        <div class="inner-container">
            <div class="section-icons-outer parallax-scene-4">
                <div data-depth="0.20" class="icon-layer"
                    style="background-image: url({{ asset('FrontEnd') }}/assets/images/icons/icon-1.png)"></div>
                <div data-depth="0.20" class="pattern-layer"
                        ...
                        <div class="list-outer">
                            <ul class="choose-list">
                                <li>
                                    ...
                                    We can help with your financing plan, we can offer some tips and tricks. Drive off
                                    with this
        ...
        <div class="coverage-section-container">
            <div class="text-container">
                ...
                <div class="row align-items-center justify-content-center">
                    @foreach($featured_category->take(6) as $fc)
                        ...
                        <div class="cats_side_wrap text-center mx-auto mb-3">
                            ...
                            <div class="sl_cat_02">
                                <h6 class="m-0 ft-medium fs-sm"><a
                                        href="{{ route('product.category', $fc->slug) }}">{{ $fc->name_en }}</a></h6>
                            </div>
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="box-item">
                    <a href="#">
                        <div class="hover-container">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Group_557" data-name="Group 557" width="60"
                                height="40" viewBox="0 0 164.104 64.102">
        ...
        <div class="inner-container">
            ...
            <div class="three-item-carousel owl-carousel owl-theme">
                ...
                <div class="service-block">
                    <div class="inner-box">
                        <div class="image">
                            <a href="#"><img src="{{ asset('FrontEnd') }}/assets/images/resource/service-2.jpg"
                                    alt="" /></a>
                        </div>
                        <div class="lower-content">
                            ...
                            <div class="car-info">
                                <div class="row pt-2">
                                    <div class="col-lg-3">
                                        <span><img src="{{ asset('FrontEnd') }}/assets/images/icons/speedometer.svg"
                                                alt=""></span>
                                        <p>85000.00 km</p>
                                    </div>
                                    <div class="col-3">
                                        <span><img src="{{ asset('FrontEnd') }}/assets/images/icons/car.svg"
                                                alt=""></span>
                                        <p>1500 cc</p>
                                    </div>
                                    <div class="col-3">
                                        <span><img src="{{ asset('FrontEnd') }}/assets/images/icons/petrol.svg"
                                                alt=""></span>
                                        <p>Octane, Hybrid</p>
                                    </div>
                                    <div class="col-3">
                                        <span><img
                                                src="{{ asset('FrontEnd') }}/assets/images/icons/manual-transmission.svg"
                                                alt=""></span>
                                        <p>Auto</p>
                                    </div>
                                </div>
    ...
    <div class="auto-container">
        <div class="inner-container">
            <div class="section-icons-outer parallax-scene-2">
                <div data-depth="0.20" class="icon-layer-one"
                    style="background-image: url({{ asset('FrontEnd') }}/assets/images/icons/icon-1.png)">
                </div>
            </div>
            <div class="row clearfix">
                <!-- Image Column -->
                        ...
                        <div class="single-item-carousel owl-carousel owl-theme">
                            ...
                            <div class="testimonial-block">
                                <div class="inner-box">
                                    ...
                                    <div class="text">
                                        A great experience, plenty of useful information given and no pressure put on me
                                        to buy.
                                    ...
                                    <div class="author-box">
                                        <div class="box-inner">
                                            <div class="author-image">
                                                <img src="{{ asset('FrontEnd') }}/assets/images/resource/author-2.jpg"
                                                    alt="" />
                                            </div>
                                            Luiz Jenifer<br />
                            ...
                            <div class="testimonial-block">
                                <div class="inner-box">
                                    ...
                                    <div class="text">
                                        Their committed sales staff strive to find the right model for every customer to
                                        suit their
                            ...
                            <div class="testimonial-block">
                                <div class="inner-box">
                                    ...
                                    <div class="text">
                                        A really positive car-buying experience. No hard sell, but plenty of time to
                                        show us the car
        ...
        <div class="inner-container">
            ...
            <div class="row clearfix">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="#"><img src="{{ asset('FrontEnd') }}/assets/images/resource/news-1.jpg"
                                    alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <ul class="post-meta">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="#"><img src="{{ asset('FrontEnd') }}/assets/images/resource/news-2.jpg"
                                    alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <ul class="post-meta">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="#"><img src="{{ asset('FrontEnd') }}/assets/images/resource/news-3.jpg"
                                    alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <ul class="post-meta">
...
<div class="clients-section">
    <div class="auto-container">
        <div class="section-icons-outer parallax-scene-10">
            <div data-depth="0.50" class="pattern-layer"
