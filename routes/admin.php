...
use App\Http\Controllers\Backend\CarsmController;
...
Route::get('/getCarsByBrand/{brand_id}', [CarsmController::class, 'getCarsByBrand'])->name('getCarsByBrand');
...
Route::middleware('adminAccess')->group(function(){
    ...
    // ==================== Admin Model All Routes ===================//
    Route::prefix('carsm')->group(function(){
        Route::get('/view', [CarsmController::class, 'index'])->name('carsm.all');
        Route::get('/add', [CarsmController::class, 'create'])->name('carsm.add');
        Route::post('/store', [CarsmController::class, 'store'])->name('carsm.store');
        Route::get('/edit/{id}', [CarsmController::class, 'edit'])->name('carsm.edit');
        Route::post('/update/{id}', [CarsmController::class, 'update'])->name('carsm.update');
        Route::get('/delete/{id}', [CarsmController::class, 'destroy'])->name('carsm.delete');
    ...
    // <--------- Banner route start ------>
	Route::resource('/cars', BannerController::class);
	Route::post('/cars/update/{id}', [BannerController::class, 'update'])->name('cars.update');
	Route::get('/cars/delete/{id}', [BannerController::class, 'destroy'])->name('cars.delete');
	Route::get('/cars/active/{id}', [BannerController::class, 'active'])->name('cars.active');
	Route::get('/cars/inactive/{id}', [BannerController::class, 'inactive'])->name('cars.in_active');
